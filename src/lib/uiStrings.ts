...
const en: UiStrings = {
  ...
  sectionTabHint:
    "Click to select · drag to reorder · double-click to rename · × deletes when selected",
  ...
  countDeleteHint: "× appears when selected · click to delete (confirmation required)",
  ...
  projectDeleteRevealHint: "× on the right deletes (with confirmation)",
...
const ja: UiStrings = {
  ...
  projectDeleteRevealHint: "右端の × で削除（確認あり）",
